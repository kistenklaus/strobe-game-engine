...
struct PNF_ShaderObjectFunctions {
  ...
  bool available() const noexcept {
    return createShaders != nullptr &&
           destroyShader != nullptr &&
           cmdBindShaders != nullptr &&
           getShaderBinaryData != nullptr &&
           cmdSetVertexInput != nullptr &&
           cmdSetRasterizationSamples != nullptr &&
           cmdSetSampleMask != nullptr &&
           cmdSetAlphaToCoverageEnable != nullptr &&
           cmdSetPolygonMode != nullptr &&
           cmdSetDepthClampEnable != nullptr &&
           cmdSetLogicOpEnable != nullptr &&
           cmdSetLogicOp != nullptr &&
...
load_shader_object_functions(VkDevice device) noexcept {
  ...
  functions.createShaders =
      reinterpret_cast<PFN_vkCreateShadersEXT>(
          vkGetDeviceProcAddr(
              device,
              "vkCreateShadersEXT"));

  functions.destroyShader =
      reinterpret_cast<PFN_vkDestroyShaderEXT>(
          vkGetDeviceProcAddr(
              device,
              "vkDestroyShaderEXT"));

  functions.cmdBindShaders =
  ...
  functions.cmdSetLogicOp =
      reinterpret_cast<PFN_vkCmdSetLogicOpEXT>(
          vkGetDeviceProcAddr(
              device,
              "vkCmdSetLogicOpEXT"));
...
inline VkResult
vk_create_shaders(
    const PNF_ShaderObjectFunctions *functions,
    VkDevice device,
  ...
  return functions->createShaders(
      device,
      createInfoCount,
      createInfos,
      allocator,
...
vk_get_shader_binary_data(
  ...
  return functions->getShaderBinaryData(
      device,
      shader,
      dataSize,
      data);
...
inline void
vk_cmd_set_rasterization_samples(
    const PNF_ShaderObjectFunctions *functions,
    VkCommandBuffer commandBuffer,
...
inline void
vk_cmd_set_alpha_to_coverage_enable(
    const PNF_ShaderObjectFunctions *functions,
    VkCommandBuffer commandBuffer,
...
inline void
vk_cmd_set_color_blend_equation(
    const PNF_ShaderObjectFunctions *functions,
    VkCommandBuffer commandBuffer,
    uint32_t firstAttachment,
    uint32_t attachmentCount,
...
inline void
vk_cmd_set_alpha_to_one_enable(
    const PNF_ShaderObjectFunctions *functions,
    VkCommandBuffer commandBuffer,
    VkBool32 enable) noexcept {
...
inline void
vk_cmd_set_patch_control_points(
    const PNF_ShaderObjectFunctions *functions,
    VkCommandBuffer commandBuffer,
