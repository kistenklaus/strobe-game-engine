...
#include "strobe/gpu/device/build_flags_utils.hpp"
#include "strobe/gpu/device/geometry_flags_utils.hpp"
#include "strobe/gpu/device/handle.hpp"
#include "strobe/gpu/device/image_impl.hpp"
#include "strobe/gpu/device/index_type_utils.hpp"
...
Blas MemoryPool::create_blas(const BlasInfo &info,
      ...
      VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR;
  {
    ...
    vulkan::vk_get_acceleration_structure_build_sizes(
        impl->context.get()->pnf(), impl->context.get()->device(),
  ...
  vulkan::AccelerationStructure accelerationStructure;
  {
    ...
    accelerationStructure =
        vulkan::create_acceleration_structure(impl->context.get(), createInfo);
  }
