...
/**
 * \ingroup rhi
 * \brief Synchronization access scope.
 ...
 * inline constexpr AccessScope color_attachment = color_attachment_read | color_attachment_write;
 * inline constexpr AccessScope depth_stencil = depth_stencil_read | depth_stencil_write;
 * inline constexpr AccessScope host = host_read | host_write;
 * \endcode
 *
 *
 * Combines pipeline stages and memory access types into a synchronization
 * scope. Access scopes may be combined using the bitwise OR operator.
 */
// [AccessScope]
struct AccessScope {
  PipelineStage stage;
...
inline constexpr AccessScope transfer =
...
inline constexpr AccessScope color_attachment =
...
inline constexpr AccessScope depth_stencil =
