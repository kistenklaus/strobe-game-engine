 ...
 * \snippet{cpp} geometry_flags.hpp GeometryFlags
 *
...
[[nodiscard]] constexpr GeometryFlags operator|(GeometryFlags lhs,
...
[[nodiscard]] constexpr GeometryFlags operator~(GeometryFlags value) noexcept {
  return static_cast<GeometryFlags>(
      ~static_cast<std::underlying_type_t<GeometryFlags>>(value));
}

constexpr GeometryFlags &operator|=(GeometryFlags &lhs,
                                    GeometryFlags rhs) noexcept {
  lhs = lhs | rhs;
  return lhs;
}
