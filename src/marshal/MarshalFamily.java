...
public class MarshalFamily {
	...
	boolean matches(MarshalEntity entity) {
		...
		if(entity.componentBits.containsAll(all))return true;
		return false;
	}
	@SafeVarargs
	...
	public static MarshalFamilyIdentifier ínstanceOf(Class<? extends MarshalComponent> component_class) {
