...
public final class Aspect{
	...
	private static String THREAD_NAME = "aspect-thread";
	...
	public static AspectContext setContext(AspectContext context) {
		...
		if(Aspect.context != null && Aspect.context.isRunning())throw new AspectException("there is already a context running");
	...
	public static void start() {
		if(context == null)throw new AspectException("There is no Context defined");
		context.start();
	}

	/**
	 * sets the context and starts it directly
	 * @version 0.0
	 * @param context
	 * @throws AspectException when the context is null
	 */
	public static void start(AspectContext context){
		setContext(context);
		start();
	}
	/**
	...
	public static AspectNode createNode(String name){
