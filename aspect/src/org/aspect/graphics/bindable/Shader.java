...
public final class Shader extends Bindable {
    ...
    public void uniformVec2(String uniformName, Vector2f vec2){
        uniformVec2(uniformName, vec2.x, vec2.y);
    }

    public void uniformVec2(String uniformName, float x, float y){
        int loc = glGetUniformLocation(ID,uniformName);
        if(loc != -1){
            glUniform2f(loc,x,y);
        }
