...
public class Aspect {
    ...
    public static VertexArray createVertexArray(boolean readonlyIbo,
                                                PrimitiveIbo ibo, boolean readonlyVbos, PrimitiveVbo... vbos) {
    ...
    public static VertexBuffer createVertexBuffer(PrimitiveVbo primitive, boolean readonly) {
    ...
    */
    ...
    public static IndexBuffer createIndexBuffer(PrimitiveIbo primitive, boolean readonly) {
